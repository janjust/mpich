...
static int get_mpi_type_contents(void *mpi_type, int max_integers, int max_addresses, int max_datatypes,
...
static int get_mpi_type_envelope(void *mpi_type, int *num_integers,
                                 int *num_addresses, int *num_datatypes,
                                 hcoll_mpi_type_combiner_t *combiner) {
    int ret, mpi_combiner;

    ret = MPIDU_Type_get_envelope( *((MPI_Datatype *) mpi_type),
                                    num_integers,
                                    num_addresses,
                                    num_datatypes,
                                    &mpi_combiner);
...
static int get_mpi_type_contents(void *mpi_type, int max_integers, int max_addresses, int max_datatypes,
    ...
    ret = MPIDU_Type_get_contents( *((MPI_Datatype *) mpi_type),
...
static int get_hcoll_type(void *mpi_type, dte_data_representation_t *hcoll_type) {
    ...
    MPID_Datatype_get_ptr(*(MPI_Datatype *)mpi_type, mpi_type_ptr);
